  ...
  return (
    <>
      ...
      <div className="space-y-1.5 mb-2">
        ...
        <p className="text-[14px] text-[var(--text-secondary)]">Use your Nexus account to continue.</p>
      </div>
      ...
      <form className="flex flex-col gap-4 mt-2" onSubmit={handleLogin}>
        ...
        <button 
          type="submit" 
          className="w-full min-h-[44px] bg-[var(--accent)] text-white rounded-[980px] px-[20px] py-[12px] font-medium hover:bg-[var(--accent-hover)] transition-colors mt-2 text-[15px]"
        >
          Sign In
        </button>
      </form>
      ...
      <button
        ...
        className="w-full min-h-[44px] bg-[var(--bg-surface)] border border-[var(--border)] text-[var(--text-primary)] rounded-[980px] px-[20px] py-[11px] font-medium hover:bg-[var(--bg-elevated)] transition-colors text-[15px] flex items-center justify-center gap-3 shadow-[var(--shadow-sm)]"
      >
      ...
      <div className="text-center mt-6">
        <Link href="/register" className="text-[14px] text-[var(--text-secondary)] hover:text-[var(--accent)] transition-colors">
