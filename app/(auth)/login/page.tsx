  ...
  return (
    <>
      ...
      <button
        ...
        className="w-full bg-[var(--bg-surface)] border border-[var(--border)] text-[var(--text-primary)] rounded-[980px] px-[20px] py-[11px] font-medium hover:bg-[var(--bg-elevated)] transition-colors text-[15px] flex items-center justify-center gap-3 shadow-[var(--shadow-sm)]"
      >
